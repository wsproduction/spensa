...
<div id="box-edit-description">
    ...
    <table>
        ...
        <tr>
            <td><?php Form::label('Status', 'description'); ?></td>
            <td>:</td>
            <td>
                <?php
        ...
        <tr>
            <td><?php Form::label('Keterangan', 'reason'); ?></td>
            <td>:</td>
            <td>
                <?php
...
<script>
    ...
    $(function(){
        ...
        $('#box-edit-description').dialog({
            ...
            draggable: false,
            open : function(){
                $('#fEditDescription')[0].reset();
                $('#fEditDescription #view-message').html('');
