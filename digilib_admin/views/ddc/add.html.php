    ...
    $(function() {
        ...
        $('#level').live('change', function() {
            ...
            if ($(this).val() == 2) {
                ...
                $('tr.sub1 td.sub1').html('<select id="sub1"><option value="form-grey">Loading...</option></select>');
                form_tips('sub1');
                $("#fAdd #sub1").rules("add", {
                    required: true
                });
                ...
                var sub2 = '<select id="sub2" name="sub2" class="form-grey" tips="Chose Level DDC">';
