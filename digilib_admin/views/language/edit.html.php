<div class="maincontent">
    <div class="maincontentinner">
        ...
        <div class="widgetcontent">
            <div id="message"></div>
            <?php
            Form::begin('fAdd', 'language/update/' . $id, 'post');
            ?>
            <div>
                <table>
                    <tr>
                        <td style="width: 200px;">
                            <div class="label-ina">Nama Bahasa</div>
                            <div class="label-eng">Language Name</div>
                        </td>
                        <td>:</td>
                        <td>
                            <?php
                            ...
                            Form::value($dataEdit['language_name']);
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            Form::option(array('0' => 'Disabled', '1' => 'Enabled'), null, $dataEdit['language_status']);
                            Form::style('form-grey');
                            Form::commit();
                            ?>
                        </td>
