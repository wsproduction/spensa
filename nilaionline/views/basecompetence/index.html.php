<div class="box-static">
    ...
    <div class="description">Berikut adalah daftar kompentensi dasar :</div>
    <div style="padding: 5px;">
        <table id="list-base-competence" style="width: 100%" class="table-list" cellspacing="0" cellpadding="0" link_r="<?php echo $link_r_basecompetence; ?>" link_d="<?php echo $link_d_basecompetence; ?>">
            <thead>
                <tr>
                    <td class="first" style="width: 50px;text-align: center;">No.</td>
                    <td>Kompetensi Dasar</td>
                    <td style="width: 100px;text-align: center;">KKM</td>
...
<div id="box-add-data">
    <?php
    Form::begin('fAddData', 'basecompetence/create', 'post', true);
    ?>

    <table cellspacing="2" cellpadding="2">
        <tr>
            <td style="width: 120px;">Kompetensi Dasar</td>
            <td>:</td>
            <td>
                <?php
                Form::create('text', 'base_competence');
                Form::size(50);
...
<div id="box-edit-data">
    <?php
    Form::begin('fEditData', 'basecompetence/update', 'post', true);
...
<script type="text/javascript">
    $(function(){
        ...
        var read_base_competence = function() {
            var link = $('#list-base-competence').attr('link_r');       
            ...
            $.post(link, { subject : subject_id,  period : period_id,  semester : semester_id, grade : grade_id}, function (o){
                $('#list-base-competence').children('tbody').attr('count',o['count']);
                $('#list-base-competence').children('tbody').html(o['row']);
        ...
        var delete_base_competence = function(id) {
            var link = $('#list-base-competence').attr('link_d');
            $(this).loadingProgress('start');
        ...
        $('a[rel=edit]').live('click',function() {
            ...
            var title = $('#list-base-competence #row_' + id).children('.competence_title').text();
            var mlc = $('#list-base-competence #row_' + id).children('.competence_mlc').text();
