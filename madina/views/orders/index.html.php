...
<div id="box-filter-product">
    ...
    <table id="list-product-search" link_r="<?php echo $link_cart; ?>">
    </table>
    <?php
    Form::end();
    ?>
...
<script>
    $(function() {
        ...
        $('#frm_members').live('submit', function() {
            ...
            $.post(url, data, function(o){
                ...
                if (o[0]) {
                    ...
                    $('#box-search-members').slideUp('fast', function(){
                        $('#box-info-members').slideDown('fast');
                    });
                } else {
        ...
        $('a[href=#changeid]').live('click', function(){
            $('#frm_members')[0].reset();
            $('#box-info-members').slideUp('fast', function(){
                $('#box-search-members').slideDown('fast');
            });
            return false;
        });
